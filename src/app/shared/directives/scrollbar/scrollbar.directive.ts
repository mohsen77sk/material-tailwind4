...
export class MskScrollbarDirective implements OnChanges, OnInit, OnDestroy {
  ...
  @Input({ transform: booleanAttribute }) mskScrollbar = true;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if ('mskScrollbar' in changes) {
      ...
      this.mskScrollbar = coerceBooleanProperty(changes['mskScrollbar'].currentValue);
    ...
    if ('mskScrollbarOptions' in changes) {
      // Merge the options
      this._options = Object.assign({}, this._options, changes['mskScrollbarOptions'].currentValue);
